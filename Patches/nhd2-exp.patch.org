...
+	[  --with-boxtype          valid values: generic,dgs,gigablue,dreambox,xtrend,fulan,kathrein,ipbox,topfield,fortis_hdbox,octagon,atevio,fortis,adb_box,whitebox,vip,homecast,vuplus,azbox,technomate,coolstream,hypercube,venton,xp1000,odin,ixuss,iqonios,e3hd,ebox5000],
 	[case "${withval}" in
...
+		generic|dgs|gigablue|dreambox|xtrend|fulan|kathrein|ipbox|topfield|fortis_hdbox|octagon|atevio|fortis|adb_box|whitebox|vip|homecast|vuplus|azbox|technomate|coolstream|hypercube|venton|xp1000|odin|ixuss|iqonios|e3hd|ebox5000)
 			BOXTYPE="$withval"
 			;;
 		cu*)
@@ -418,6 +418,14 @@
...
+				valid for fortis: hs7110,hs7810a,hs7119,hs7819,dp7000
...
+			fi
+			;;
+		hs7110|hs7810a|hs7119|hs7819|dp7000)
...
+	AC_DEFINE(BOXMODEL_DP7000, 1, [building for dp7000])
+
